...
let StockImage = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = view(), _dec4 = call({}), _dec5 = view(), _dec6 = call({}), _dec7 = view(), _dec(_class = (_class2 = class StockImage {
  ipfsBaseUrl = "";
  ownerAccs = [];
  royalties = [];
  ...
  add_owner_images({
    ...
    log(`Saving image ${image.title} for account ${owner_acc}`);
    const obj = this.ownerAccs.find(k => k.ownerAcc === owner_acc);
    if (obj) {
  ...
  get_royalty_amount({
    ...
    const obj = this.ownerAccs.find(k => k.ownerAcc === owner_acc);
    if (obj) {
      const image = obj.images.find(k => k.title === image_title);
      if (image) {
  ...
  get_royalty({
    ...
    const obj = this.royalties.find(k => k.account === account && k.image.title === image_title);
    return obj;
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "get_base_ipfs_url", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_base_ipfs_url"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_images", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_images"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_owner_images", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "add_owner_images"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_royalty_amount", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_royalty_amount"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "pay_royalty", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "pay_royalty"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_royalty", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "get_royalty"), _class2.prototype)), _class2)) || _class);
function get_royalty() {
  const _state = StockImage._getState();
  if (!_state && StockImage._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = StockImage._create();
  if (_state) {
    StockImage._reconstruct(_contract, _state);
  }
  const _args = StockImage._getArgs();
  const _result = _contract.get_royalty(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(StockImage._serialize(_result, true));
}
function pay_royalty() {
  ...
  const _args = StockImage._getArgs();
  const _result = _contract.pay_royalty(_args);
  StockImage._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(StockImage._serialize(_result, true));
}
function get_royalty_amount() {
  const _state = StockImage._getState();
  if (!_state && StockImage._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = StockImage._getArgs();
  const _result = _contract.get_royalty_amount(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(StockImage._serialize(_result, true));
}
function add_owner_images() {
  const _state = StockImage._getState();
  if (!_state && StockImage._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = StockImage._getArgs();
  const _result = _contract.add_owner_images(_args);
  StockImage._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(StockImage._serialize(_result, true));
}
function get_all_images() {
  ...
  const _args = StockImage._getArgs();
  const _result = _contract.get_all_images(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(StockImage._serialize(_result, true));
}
function get_base_ipfs_url() {
  const _state = StockImage._getState();
  if (!_state && StockImage._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = StockImage._getArgs();
  const _result = _contract.get_base_ipfs_url(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(StockImage._serialize(_result, true));
}

export { add_owner_images, get_all_images, get_base_ipfs_url, get_royalty, get_royalty_amount, pay_royalty };
//# sourceMappingURL=stock_image.js.map
